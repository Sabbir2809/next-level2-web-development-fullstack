...
SELECT department_name, total_salary FROM -- outer query/ main query
  (SELECT department_name, sum(salary) as total_salary FROM employees GROUP BY department_name); -- sub query
