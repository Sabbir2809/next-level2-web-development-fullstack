    ...
    <Container>
      <Box my={5}>
        ...
        <Typography
          ...
          variant="h6">
          Compassionate and dedicated doctor committed to delivering high-quality care. Proficient
          in diagnosis, treatment, and advocating for comprehensive well-being. Prioritizing
                ...
                <Box>
                  <Stack direction="row">
                    ...
                    <Stack
                      ...
                      <Typography>Taka : {doctor?.appointmentFee} (incl. Vat)</Typography>
